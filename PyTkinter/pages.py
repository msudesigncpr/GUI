...
class tkinterApp(tk.Tk):
    ...
    def data_button(self, petris):   
        ...
        messagebox.showinfo("STATUS", f"ARE THE PETRI DISHED ORIENTED CORRECTLY \n & \n DO YOU HAVE {petris} PETRI DISHES PLACED 1 THROUGH {petris}")
...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        page1 = ttk.Button(self, text="Input Data Options", command=lambda: controller.show_frame(Page1))
        page1.grid(row=2, column=1, padx=10, pady=10)
        page2 = ttk.Button(self, text="Calibarate Camera", command=lambda: controller.show_frame(Page2))
        page2.grid(row=3, column=1, padx=10, pady=10)

        #label for what to do on this page
        hello = ttk.Label(self, text = "Welcome to the colony picking robot, please select a following option", font = smallFont)
...
class Page1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button = ttk.Button(self, text="Input data", command=lambda: self.dataInput(controller))
        button.grid(row=9, column=2)
        
        #buttons to other pages
        moveOn = ttk.Button(self, text="Continue", command=lambda: controller.show_frame(Steps))
        moveOn.grid(row=10, column=2, padx=10, pady=10)
        start = ttk.Button(self, text="StartPage", command=lambda: controller.show_frame(StartPage))
...
class Steps(tk.Frame):
    def __init__(self, parent, controller): #page1_instance
       ...
       # i = num_petri_dishes
        ...
        i = "1"
        petrisName = tk.Label(self, text=f"Insert name of Petri dish{i}", font=smallFont)
        ...
        dataName = tk.Label(self, text="Taking Picture ", font=smallFont)       #take pic after checking if at the right location
        ...
        button2 = ttk.Button(self, text="QUIT", command=lambda: controller.show_frame(StartPage))
...
class Page2(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button = ttk.Button(self, text="Take an Image", command=lambda: controller.takePhoto()) #may need to remove () at end
