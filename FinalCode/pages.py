...
class UserInputs(tk.Frame):
    def __init__(self, parent, controller):
        ...
        close_button = tk.Button(self, text="Close", command=controller.destroy)
        close_button.grid(row=15, column=2)
        ...
        confirm = ttk.Button(self, text="Validate Inputs", command=lambda: self.verifyInput())
